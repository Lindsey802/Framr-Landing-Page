...
export const Intercom = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 8.968 8.972" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Intercom" {...props}>
